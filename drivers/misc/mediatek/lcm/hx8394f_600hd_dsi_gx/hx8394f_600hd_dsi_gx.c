...
static struct LCM_setting_table lcm_initialization_setting[] = {
    ...
    {0xBA, 13, {0x62,0x03,0x68,0x83,0xB2,0x40,0x00,0x01,0x00,0x00,0x00,0x80,0x0C}},
	{0xB1, 10, {0x48,0x15,0x75,0x09,0x32,0x54,0xB1,0x71,0x57,0x43}},
	{0xD2, 1, {0x88}},
	{0xE0, 58, {0x00,0x0A,0x16,0x1D,0x21,0x25,0x2A,0x29,0x55,0x66,
                0x77,0x76,0x7E,0x90,0x94,0x96,0xA1,0xA2,0x9E,0xAA,
                0xBA,0x5B,0x5A,0x5D,0x61,0x64,0x6A,0x76,0x7F,0x00,                                          
                0x0A,0x16,0x1D,0x21,0x25,0x2A,0x29,0x55,0x66,0x77,
                0x75,0x7D,0x8F,0x93,0x95,0xA0,0xA2,0x9F,0xAA,0xBA,
                0x5B,0x5A,0x5D,0x61,0x64,0x6A,0x76,0x7F}},
	{0xB2, 6, {0x00,0xA0,0x44,0x0C,0x0D,0x50}},
	{0xB4, 21, {0x8D,0x8D,0x8D,0x8D,0x8D,0x8D,0x0C,0x0C,0xAF,0x35,0x00,0x3F,0x8D,0x8D,0x8D,0x8D,0x8D,0x8D,0x0C,0x0C,0xAF}},
	{0xC7, 2, {0x00,0xC0}},
	{0x35, 1, {0x00}},
    {0xBD, 1, {0x01}},
    {0xB1, 1, {0x00}},
    {0xBD, 1, {0x00}},
    {0xC0,2,{0x1F,0x31}},  //OTP 漏烧
    {0xD4,1,{0x02}},       //OTP 漏烧
    {0xC6,1,{0xED}},       //OTP 漏烧
};
...
extern unsigned int gtp_call_gesture_flag;
extern int fts_call_ps_flag;
static void lcm_suspend_power(void)
{
	if(get_huaqin_pcba_config() <= 0x31 && (gtp_call_gesture_flag ||  fts_call_ps_flag)){
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	#endif
    params->dsi.lcm_esd_check_boe_flag = 0;
}
...
static void lcm_init_lcm(void)
{
	...
	printk("[Kernel/LCM] ---lcm_init--hx8394f-\n");
...
{
	printk("%s, select hx8394f_600hd_dsi_gx\n", __func__);
    return 1;
}

LCM_DRIVER hx8394f_600hd_dsi_gx_lcm_drv = {
	.name = "hx8394f_600hd_dsi_gx",
