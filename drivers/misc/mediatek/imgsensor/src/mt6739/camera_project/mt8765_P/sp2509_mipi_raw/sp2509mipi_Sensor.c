...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0xbf52e90e,        //checksum value for Camera Auto Test
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_R,//sensor output first pixel color //modified by lvyun
...
static void sensor_init(void)
{
	...
	if(fromsd == 1)//是否从SD读取//gepeiwei   120903
      ...
      write_cmos_sensor(0xfb,0x73);//9.29canshu 63
			write_cmos_sensor(0xfd,0x01);
			write_cmos_sensor(0x3f,0x03); //add mirror by lvyun
...
UINT32 SP2509_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc)
{
