...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
	...
	{
		SENSOR_DRVNAME_GC2375HMIPI_RAW,
		{
...
#endif
#if defined(GC2375HMIPI_FRONT_RAW)
	{
		SENSOR_DRVNAME_GC2375HMIPI_FRONT_RAW,
		{
			{PDN, Vol_High, 0, Vol_High, 0},
			{RST, Vol_Low, 0, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(SP2509FRONT_MIPI_RAW)
	{
		SENSOR_DRVNAME_SP2509FRONT_MIPI_RAW,
		{
			{PDN, Vol_High, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
