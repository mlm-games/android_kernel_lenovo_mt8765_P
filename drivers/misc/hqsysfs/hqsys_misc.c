...
static int emmc_get_emmc_name(char *emmc_name)
{
	...
	if (0 == msdc_emmc_get_prod_name(emmc_prod_name)) {
		...
		if(strncmp(emmc_prod_name,"H8G4a2",6) == 0) {
			strcpy(emmc_name,"HYNIX H9TQ64A8GTDCUR_KUM");
		}
		else if(strncmp(emmc_prod_name,"HAG4a2",6) == 0) {
			strcpy(emmc_name,"HYNIX H9TQ17ABJTCCUR_KUM");
		}
		else if(strncmp(emmc_prod_name,"QE63MB",6) == 0) {
			strcpy(emmc_name,"SAMSUNG KMQE60013M-B318");
		}
		else if(strncmp(emmc_prod_name,"FE62MB",6) == 0) {
			strcpy(emmc_name,"SAMSUNG KMFE60012M-B214");
		}
		else if(strncmp(emmc_prod_name,"FN62MB",6) == 0) {
			strcpy(emmc_name,"SAMSUNG KMFN60012M_B214");
		}
		else if(strncmp(emmc_prod_name,"QX63AB",6) == 0) {
			strcpy(emmc_name,"SAMSUNG KMQX60013A-B419");
		}
		else if(strncmp(emmc_prod_name,"UY5CS0",6) == 0) {
			strcpy(emmc_name,"UNIC UNPVN5G4CACA4BS");
		} else {
